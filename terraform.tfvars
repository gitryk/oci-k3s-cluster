...
nsg_rule = {
  "0" = [ #lb
    ...
    { min = 443, max = null, type = 17, direction = "INGRESS", target = "0.0.0.0/0", target_type = "CIDR_BLOCK", description = "Allow QUIC (EXT → LB)" },
  ],
  "1" = [ #worker
    { min = 80, max = null, type = 6, direction = "INGRESS", target = "0", target_type = "NETWORK_SECURITY_GROUP", description = "Allow HTTP (LB → Worker)" },
    { min = 443, max = null, type = 6, direction = "INGRESS", target = "0", target_type = "NETWORK_SECURITY_GROUP", description = "Allow HTTPS (LB → Worker)" },
